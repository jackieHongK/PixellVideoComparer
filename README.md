...
## Design reference (Revolut-inspired)

- This project installs and uses `DESIGN.md` generated by:
  - `npx getdesign@latest add revolut`
- UI updates should follow that design guidance (typography, color discipline, pill controls, no-shadow surfaces) while keeping the project as lightweight single-file HTML.
